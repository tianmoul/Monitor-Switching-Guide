...
- **Extension hub supported HDMI port sometimes would fail to answer to m1ddc**: Use a USB-C port to connect with second screen
...
- **扩展坞的HDMI接口有时会不响应m1ddc的指令**: 使用USB-C线对第二个屏幕进行连接
